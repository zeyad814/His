...
class UpdatePregnancyVisitRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'pregnancy_id'          => 'sometimes|exists:pregnancies,id',
            'doctor_id'             => 'sometimes|exists:doctors,id',
            'visit_id'         => 'sometimes|exists:visits,id',

            //التواريخ
            'visit_date'            => 'sometimes|date|before_or_equal:today', // تاريخ الزيارة الحالي
